Array.prototype.unique = function () {//ȥ�����ظ�
...
var Iput = {
    ...
    hide: function (e) {//����κδ��رղ�
        e = window.event || e;
        var srcElement = e.srcElement || e.target;
        if (Iput.confg.event == undefined) {//����ʱ��,����û����Iput.confg.event�����ʹ��
            Iput.colse();
        }
        else {
    ...
    contains: function (star, end, isIgnoreCase) {
        ...
        for (var j = 0; j < star.length - strLen + 1; j++) {
            if (star.charAt(j) == startChar)//���ƥ����ʼ�ַ�,��ʼ����
            {
                if (star.substring(j, j + strLen) == end)//����j��ʼ���ַ���strƥ�䣬��ok
                {
                    return true;
                }
            }
