...
//            r.drag && i.drag(s, n)
            ...
            function () {
                ...
                return r.check ? '<i class="layui-icon layui-tree-check"  value=' + n.id + ' lay-id=' + n.id + ' layui-ckeck="' + n.checked + '">' + checkbox + "</i>" : ""
            }(),
            function () {
                return '<a href="' + (n.href || "javascript:;") + '" ' + (r.target && n.href ? 'target="' + r.target + '"' : "") + ">" + ('<i class="layui-icon layui-tree-' + (l ? "branch" : "leaf") + '">' + (l ? n.spread ? t.branch[1] : t.branch[0] : t.leaf) + "</i>") + ("<cite>" + (n.name || "未命名") + "</cite></a>")
            }(), "</li>"].join(""));
    ...
    r.prototype.checkedClick = function (e, q) {
        var a = this,
        i = a.options;
  ...
  r.prototype.currentNode = function (element, ck) {
      var a = this;
    ...
    r.prototype.childrenNode = function (element, ck) {
        var a = this;
   ...
   r.prototype.parentNode = function (element, ck) {
