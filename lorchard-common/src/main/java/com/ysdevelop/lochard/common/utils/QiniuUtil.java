...
public class QiniuUtil {
	 ...
	 * 生成上传凭证，然后准备上传
	 */
	private static String accessKey = "3TLUo368Al_KDgL8QydrnY7jRijtYApGj2u9fSPP";
	private static String secretKey = "Su8a2abpVMeHfFi2wTuN7dQ9VP67djeRajJVrMV6";
	private static String bucket = "lorchar-mall-images";
	//测试域名
	private static String origin = "http://pdjllrqfe.bkt.clouddn.com/";
