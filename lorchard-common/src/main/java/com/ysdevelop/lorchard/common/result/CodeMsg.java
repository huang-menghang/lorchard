...
public class CodeMsg {
	...
	public static CodeMsg ORIGINALPRIVE_LESS_THAN_SPELLINGGROUPPRICE=new CodeMsg(500032,"正常价应该大于团购价");
	public static CodeMsg GOODS_STOCK_CHANGE=new CodeMsg(500062,"商品库存不足,请取消订单,重新下单");
